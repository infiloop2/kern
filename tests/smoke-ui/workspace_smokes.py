...
def web_app_turn_budget_smoke(page: Any) -> None:
    smoke = getattr(_load_workspace_smoke("web_apps"), "turn_budget_smoke", None)
    if smoke is None:
        raise AssertionError("web_apps smoke.py is missing turn_budget_smoke()")
    smoke(page)
