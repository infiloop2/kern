...
GUARDED_FIELDS = {
    ...
    ("elevenlabs", "design_voice", "text"),
    ("elevenlabs", "save_voice", "name"),
    ("elevenlabs", "save_voice", "voice_description"),
    ("elevenlabs", "generate_speech", "text"),
    ("elevenlabs", "generate_music", "prompt"),
    ("elevenlabs", "generate_music", "sections"),
    ("elevenlabs", "generate_sound_effect", "text"),
...
EXEMPT_FIELDS = {
    ...
    ("elevenlabs", "preview_voice", "generated_voice_id"): TYPED,
    ("elevenlabs", "save_voice", "generated_voice_id"): TYPED,
    ("elevenlabs", "generate_speech", "voice_id"): TYPED,
    ("elevenlabs", "generate_speech", "model"): TYPED,
    ("elevenlabs", "generate_speech", "stability"): TYPED,
    ("elevenlabs", "generate_speech", "style"): TYPED,
    ("elevenlabs", "generate_speech", "speed"): TYPED,
    ("elevenlabs", "generate_speech", "similarity_boost"): TYPED,
    ("elevenlabs", "generate_music", "duration_ms"): TYPED,
    ("elevenlabs", "generate_music", "force_instrumental"): TYPED,
    ("elevenlabs", "generate_sound_effect", "duration_seconds"): TYPED,
    ("elevenlabs", "generate_sound_effect", "loop"): TYPED,
    ("elevenlabs", "generate_sound_effect", "prompt_influence"): TYPED,
    ...
    ("apify_developer", "set_latest_build", "actor_id"): APPROVAL_GATED,
    ("apify_developer", "set_latest_build", "build_id"): APPROVAL_GATED,
    ("apify_developer", "set_latest_build", "test_run_id"): APPROVAL_GATED,
    ...
    ("runway", "generate_speech", "model"): TYPED,
    ("runway", "generate_speech", "stability"): TYPED,
    ("runway", "generate_speech", "style"): TYPED,
    ("runway", "generate_speech", "speed"): TYPED,
