...
class AgenticWebAppContractTests(unittest.TestCase):
    ...
    def test_agent_instructions_are_current(self) -> None:
        ...
        web_app_ui = (agent_home / "references" / "web-app-ui.md").read_text()
        ...
        for reference in ("web-apps.md", "web-app-ui.md", "memory.md", "schedules.md"):
            self.assertIn(
        ...
        self.assertIn("app.askAgent(message)", web_app_ui)
        self.assertIn('data-drag-value="item-id"', web_app_ui)
        self.assertIn('data-drop-action="name"', web_app_ui)
        self.assertIn('data-drop-value="target-id"', web_app_ui)
        self.assertIn('data-enter-action="name"', web_app_ui)
        self.assertIn("draggedValue", web_app_ui)
        ...
        self.assertIn('app.query("leads", request)', web_app_ui)
