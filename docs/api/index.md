...
The API docs describe the stable JSON contracts used by deploy, the admin API,
and runtime network policy.

## Sections

| Doc | Contents |
| --- | --- |
| [Admin API](AdminAPI.md) | Localhost admin routes, auth, thread/runtime lifecycle, apps, tools, network policy, and host controls. |
