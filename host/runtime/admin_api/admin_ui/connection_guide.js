...
const INTEGRATION_LOGOS = {
  ...
  "tool:whatsapp": `<svg viewBox="0 0 32 32"><path d="M16 4.5a11.5 11.5 0 0 0-9.9 17.3L4.5 27.5l5.9-1.5A11.5 11.5 0 1 0 16 4.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.4"/><path fill="currentColor" d="M11.3 9.5c-.5 0-1.3.2-1.7 1-.4.8-.9 1.8.3 4.6 1.2 2.9 4.6 6.2 8.6 7.3 2.8.8 4.4-.6 4.9-1.4.5-.8.5-2 .3-2.3-.2-.3-3.2-1.8-3.7-1.8-.4 0-.7.3-1.2.9-.4.5-.8 1-1.3.8-1-.4-2.2-1.2-3.1-2.1-.9-1-1.6-2-1.9-2.9-.2-.5.3-.9.8-1.3.4-.4.7-.7.5-1.1-.2-.5-1.6-1.7-2.5-1.7Z"/></svg>`,
...
function toolGuide(tool) {
  const oauth = ["oauth", "mcp_oauth"].includes(tool.connection);
  return {
