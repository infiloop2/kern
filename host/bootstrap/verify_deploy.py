...
MANAGED_AGENT_FILES = (
    ...
    "/mnt/kern-agent/agent-home/.codex-2/config.toml",
    "/mnt/kern-agent/agent-home/.codex-3/config.toml",
...
PATH_FACTS: tuple[PathFact, ...] = (
    ...
    ("/mnt/kern-agent/agent-home/.codex-2", "kern-agent", "kern-agent", 0o700, True),
    ("/mnt/kern-agent/agent-home/.codex-3", "kern-agent", "kern-agent", 0o700, True),
    ...
    ("/mnt/kern-agent/agent-home/.grok-2", "kern-agent", "kern-agent", 0o700, True),
    ...
    ("/mnt/kern-agent/agent-home/.codex-2/config.toml", "root", "root", 0o644, False),
    ("/mnt/kern-agent/agent-home/.codex-3/config.toml", "root", "root", 0o644, False),
